...
#line 90 "..\\..\\..\\..\\Library\\StdDriver\\inc\\fmc.h"
...
uint8_t volatile g_u8EndFlag = 0;
uint8_t data;
typedef void (*I2C_FUNC)(uint32_t u32Status);

I2C_FUNC volatile s_I2CHandlerFn = 0;
...
void I2C_MasterRx(uint32_t u32Status)
{
    ...
    {
				data = ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->DAT );
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL & ~0x3c) | 0x08|0x04 );
    }
    else if (u32Status == 0xA0)                  
    {
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL & ~0x3c) | 0x04 | 0x08 );
    }
    else if (u32Status == 0xA8)                  
    {
					( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->DAT = 0x21 );
            ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL & ~0x3c) | 0x04 | 0x08 );
...
void SYS_Init(void)
{
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->P1_MFP &= ~(0x04000404UL | 0x08000808UL);
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->P1_MFP |= (0x00000400UL | 0x00000800UL);

     
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->P3_MFP |= (1UL << ((4) +16)) | (1UL << ((5) +16));
...
void EEPROM_Read(void)
{
   ...
   ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL & ~0x3c) | 0x04 | 0x08 );
	I2C_WAIT_READY(((I2C_T *) (((uint32_t)0x40000000) + 0x20000))); 
	while(flag){
	status=( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->STATUS );
		if(status==0x60){
			data1=( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->DAT );
			( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CTL & ~0x3c) | 0x04 | 0x08 );
			I2C_WAIT_READY(((I2C_T *) (((uint32_t)0x40000000) + 0x20000))); 
				status=( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->STATUS );
			if(status==0x80){
...
int main(void)
{
    ...
    I2C_Open(((I2C_T *) (((uint32_t)0x40000000) + 0x20000)), 50000);
    ...
    NVIC_EnableIRQ(I2C0_IRQn);
	 ...
	 tout = SystemCoreClock;
        ...
        tout = SystemCoreClock;
        while ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000))->CTL & (0x1ul << (4))) && (tout-- > 0));
        if (((I2C_T *) (((uint32_t)0x40000000) + 0x20000))->CTL & (0x1ul << (4)))
        {
